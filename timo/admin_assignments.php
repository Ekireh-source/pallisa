...
<body class="text-slate-800 antialiased h-screen flex relative">
    ...
    <main class="flex-1 flex flex-col h-full relative bg-slate-50/50">
        <header
            ...
            <div class="flex items-center gap-3">
                <div
                    class="w-8 h-8 rounded-lg bg-amber-50 text-amber-600 flex items-center justify-center border border-amber-100">
                    <i data-lucide="briefcase" class="w-4 h-4"></i></div>
            ...
            <div class="grid grid-cols-12 gap-5 flex-1 min-h-0">
                ...
                <div class="col-span-4 flex flex-col gap-5 overflow-y-auto">
                    <div class="bg-white p-5 rounded-xl  border border-slate-200 elevate-card">
                        ...
                        <form id="formAddAssignment" class="space-y-4">
                            <div class="space-y-1.5">
                                <label
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Select
                                    Teacher</label>
                                <select id="selTeacher" required
                            ...
                            <div class="pt-2">
                                <button type="submit" id="btnSaveAssignment"
                                    class="w-full bg-brand hover:bg-brand-dark text-white py-2.5 rounded-lg text-xs font-bold  active:scale-95 transition-all flex justify-center items-center gap-2">
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 p-5 rounded-xl border border-blue-100">
                        <h4 class="text-xs font-extrabold text-brand flex items-center gap-2 mb-2"><i data-lucide="info"
                                class="w-4 h-4"></i> Workflow Tip</h4>
                        <p class="text-[11px] text-slate-600 leading-relaxed">Assigning a teacher to a Stream and
                            Subject grants them immediate access to grade AOIs, SA grids, and Project Competencies for
                            that specific class.</p>
                    </div>
                </div>
                ...
                <div class="col-span-8 flex flex-col bg-white rounded-xl  border border-slate-200 overflow-hidden">
                    <div class="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50/50">
                        <div>
                            <h3 class="text-base font-extrabold text-slate-800 flex items-center gap-2">Active
                                Allocations <span id="allocationCountBadge"
                                    class="bg-slate-200 text-slate-600 text-[10px] px-2 py-0.5 rounded-full">0</span>
                            </h3>
                            <p class="text-[11px] text-slate-500 mt-0.5">Live map of who is teaching what across the
                                school.</p>
                        </div>
                        <div class="relative flex gap-2">
                            <div class="relative">
                                ...
                                <input type="text" id="inpSearchAssignment" onkeyup="filterAssignments()"
                    ...
                    <div id="assignmentsContainer"
                        ...
                        <div class="col-span-2 text-center py-10 text-slate-400"><i data-lucide="loader-2"
                                class="w-5 h-5 animate-spin mx-auto mb-2 text-brand"></i> Compiling assignments...</div>
                    </div>
                </div>
    ...
    <div id="editModal"
        ...
        <div class="bg-white rounded-2xl -2xl w-full max-w-sm p-6 transform scale-95 transition-transform duration-300"
            ...
            <p class="text-xs text-slate-500 mb-5 leading-relaxed">Update the teacher, subject, or stream for this
                allocation.</p>

            <div class="space-y-4 mb-6">
                <div class="space-y-1.5">
                    <label class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Select
                        Teacher</label>
                    <select id="selEditTeacher"
    ...
    <div id="deleteModal"
        ...
        <div class="bg-white rounded-2xl -2xl w-full max-w-sm p-6 transform scale-95 transition-transform duration-300"
            ...
            <p class="text-xs text-slate-500 mb-5 leading-relaxed">You are about to sever the link between <strong
                    id="deleteTargetInfo" class="text-slate-800"></strong>. The teacher will lose access to this stream
                immediately.</p>
