    ...
    <main class="flex-1 flex flex-col h-full relative bg-slate-50/50">
        ...
        <header
            ...
            <div class="flex items-center gap-3">
                <div
                    ...
                    <i data-lucide="calendar-check" class="w-4 h-4"></i></div>
        ...
        <div class="flex-1 p-6 overflow-hidden flex flex-col gap-5">
            ...
            <div class="grid grid-cols-4 gap-5 flex-shrink-0">
                <div
                    class="elevate-card bg-white p-5 rounded-xl  border border-slate-200 flex flex-col relative overflow-hidden">
                    <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-1">School-Wide Rate
                    </p>
                    <h3 id="kpiRate" class="text-3xl font-extrabold text-emerald-600 tracking-tight"><i
                            data-lucide="loader-2" class="w-6 h-6 animate-spin"></i></h3>
                    <div
                        class="absolute bottom-0 right-0 w-24 h-24 bg-emerald-50 rounded-full blur-2xl translate-y-10 translate-x-10">
                    </div>
                </div>
                <div
                    class="elevate-card bg-white p-5 rounded-xl  border border-slate-200 flex flex-col relative overflow-hidden">
                    <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-1">Lessons Logged
                    </p>
                    <h3 id="kpiLessons" class="text-3xl font-extrabold text-slate-800 tracking-tight"><i
                            data-lucide="loader-2" class="w-6 h-6 animate-spin"></i></h3>
                </div>
                <div
                    class="elevate-card bg-white p-5 rounded-xl  border border-slate-200 flex flex-col relative overflow-hidden">
                    <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-1">Highest
                        Attendance</p>
                    <h3 id="kpiBest" class="text-base font-extrabold text-indigo-600 tracking-tight mt-1 truncate"><i
                            data-lucide="loader-2" class="w-5 h-5 animate-spin"></i></h3>
                    <p class="text-[10px] text-slate-500 font-medium mt-0.5" id="kpiBestSub">--</p>
                </div>
                <div
                    class="elevate-card bg-white p-5 rounded-xl  border border-slate-200 flex flex-col relative overflow-hidden">
                    <p class="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-1">Lowest
                        Attendance</p>
                    <h3 id="kpiWorst" class="text-base font-extrabold text-rose-500 tracking-tight mt-1 truncate"><i
                            data-lucide="loader-2" class="w-5 h-5 animate-spin"></i></h3>
                    <p class="text-[10px] text-slate-500 font-medium mt-0.5" id="kpiWorstSub">--</p>
                </div>
            </div>

            <div class="flex-1 flex flex-col bg-white rounded-xl  border border-slate-200 overflow-hidden min-h-0">

                <div
                    class="p-4 border-b border-slate-100 bg-slate-50/80 flex items-center justify-between flex-shrink-0">
                    <div class="flex items-center gap-3">
                        <div class="relative">
                            <i data-lucide="search"
                                class="w-3.5 h-3.5 absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400"></i>
                            <input type="text" id="inpSearch" onkeyup="applyFilters()"
                                placeholder="Search Learner or LIN..."
                                class="pl-8 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-xs font-medium focus:outline-none focus:border-brand w-60 ">
                        </div>
                        <select id="selStreamFilter" onchange="applyFilters()"
                            class="bg-white border border-slate-200 text-slate-700 text-xs font-bold rounded-lg px-3 py-2 focus:outline-none focus:border-brand  cursor-pointer w-40">
                            <option value="">All Streams</option>
                        </select>
                        <select id="selSubjectFilter" onchange="applyFilters()"
                            class="bg-white border border-slate-200 text-slate-700 text-xs font-bold rounded-lg px-3 py-2 focus:outline-none focus:border-brand  cursor-pointer w-40">
                            <option value="">All Subjects</option>
                        </select>
                    </div>
                    <button onclick="exportToCSV()"
                        class="bg-slate-800 hover:bg-slate-900 text-white px-4 py-2 rounded-lg text-xs font-bold  transition-all flex items-center gap-2">
                ...
                <div class="flex-1 overflow-auto">
                    <table class="w-full text-left border-collapse whitespace-nowrap">
                        <thead>
                            <tr>
                                <th
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest py-3 px-5 border-b border-slate-200">
                                    Learner details</th>
                                <th
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest py-3 px-5 border-b border-slate-200">
                                    Stream</th>
                                <th
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest py-3 px-5 border-b border-slate-200 text-center">
                                    Total Lessons</th>
                                <th
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest py-3 px-5 border-b border-slate-200 text-center">
                                    Present</th>
                                <th
                                    ...
                                    Absent</th>
                                <th
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest py-3 px-5 border-b border-slate-200 text-right">
                                    Attendance Rate</th>
                            </tr>
                        </thead>
                        <tbody id="attendanceTableBody" class="text-sm">
                            <tr>
                                <td colspan="6" class="text-center py-10 text-slate-400 font-medium">
                                    <i data-lucide="loader-2" class="w-5 h-5 animate-spin mx-auto mb-2 text-brand"></i>
                                    Compiling attendance ledger...
                                </td>
                            </tr>
                        </tbody>
                    </table>
