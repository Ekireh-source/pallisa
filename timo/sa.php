...
<body class="text-slate-800 antialiased h-screen flex flex-col relative">
    ...
    <header
        ...
        <div class="flex justify-between items-center relative z-10">
            ...
            <h1 class="text-xl font-bold tracking-tight text-white drop-">SA Assessment Matrix</h1>
    ...
    <div id="submitBar" class="fixed bottom-[70px] left-0 w-full px-5 pb-3 hidden z-30">
        <button onclick="submitSA_Scores()" id="submitBtn"
    ...
    <nav
        ...
        <button class="flex flex-col items-center gap-1 text-brand"><i data-lucide="award"
                class="w-6 h-6 fill-brand/10"></i><span class="text-[10px] font-bold">SA Marks</span></button>
