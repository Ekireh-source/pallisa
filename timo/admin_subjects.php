...
<body class="text-slate-800 antialiased h-screen flex relative">
            ...
            <div class="grid grid-cols-12 gap-5 flex-1 min-h-0">
                ...
                <div class="col-span-4 flex flex-col gap-5 overflow-y-auto">
                    <div class="bg-white p-5 rounded-xl  border border-slate-200 elevate-card">
                        ...
                        <form id="formAddSubject" class="space-y-4">
                            <div class="space-y-1.5">
                                <label
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Subject
                                    Name</label>
                                <input type="text" id="inpSubName" placeholder="e.g., Physics" required
                            ...
                            <div class="space-y-1.5">
                                <label
                                    class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Subject
                                    Code</label>
                                <input type="text" id="inpSubCode" placeholder="e.g., PHY" required
                            ...
                            <button type="submit" id="btnSaveSubject"
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 p-5 rounded-xl border border-blue-100">
                        <h4 class="text-xs font-extrabold text-brand flex items-center gap-2 mb-2"><i data-lucide="info"
                                class="w-4 h-4"></i> Registry Guidelines</h4>
                        <p class="text-[11px] text-slate-600 leading-relaxed">Subjects are the core pillars of the
                            curriculum. Ensure that subject codes are completely unique (e.g., MTC, ENG). These codes
                            will appear on all exported Excel reports.</p>
                    </div>
                </div>
                ...
                <div class="col-span-8 flex flex-col bg-white rounded-xl  border border-slate-200 overflow-hidden">
                    <div class="flex items-center justify-between p-5 border-b border-slate-100 bg-slate-50/50">
                        <div>
                            ...
                            <p class="text-[11px] text-slate-500 mt-0.5">Manage and edit the school's curriculum
                                offerings.</p>
                        </div>
                        <div class="relative">
                            <i data-lucide="search"
                                class="w-3.5 h-3.5 absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400"></i>
                            <input type="text" id="inpSearchSub" onkeyup="filterSubjects()"
                                placeholder="Search subjects..."
                                class="pl-8 pr-3 py-1.5 bg-white border border-slate-200 rounded-lg text-xs font-medium focus:outline-none focus:border-brand w-48">
                        </div>
                    </div>
                    ...
                    <div id="subjectsContainer"
                        ...
                        <div class="col-span-2 text-center py-10 text-slate-400"><i data-lucide="loader-2"
                                class="w-5 h-5 animate-spin mx-auto mb-2 text-brand"></i> Compiling curriculum...</div>
                    </div>
                </div>
    ...
    <div id="editModal"
        ...
        <div class="bg-white rounded-2xl -2xl w-full max-w-sm p-6 transform scale-95 transition-transform duration-300"
            ...
            <p class="text-xs text-slate-500 mb-5 leading-relaxed">Changes will instantly apply to all teacher
                workloads.</p>

            <div class="space-y-4 mb-6">
                <div class="space-y-1.5">
                    <label class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Subject
                        Name</label>
                ...
                <div class="space-y-1.5">
                    <label class="text-[10px] font-extrabold text-slate-500 uppercase tracking-widest">Subject
                        Code</label>
                    <input type="text" id="inpEditCode"
                        class="w-full bg-slate-50 border border-slate-200 text-slate-800 text-sm font-bold rounded-lg px-3 py-2.5 focus:outline-none focus:border-brand focus:ring-2 focus:ring-brand/20 transition-all uppercase">
                </div>
            </div>
    ...
    <div id="deleteModal"
        ...
        <div class="bg-white rounded-2xl -2xl w-full max-w-sm p-6 transform scale-95 transition-transform duration-300"
            ...
            <p class="text-xs text-slate-500 mb-5 leading-relaxed">You are about to delete <strong id="deleteTargetName"
                    class="text-slate-800"></strong>. <span class="text-rose-500 font-bold">This will orphan related
                    scores and teacher assignments!</span></p>
