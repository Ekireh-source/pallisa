...
<head>
    ...
    <title>Projects & CAI | Academic System</title>
...
<body class="text-slate-800 antialiased h-screen flex flex-col relative">
    ...
    <header
        ...
        <div class="flex justify-between items-center relative z-10">
            ...
            <h1 class="text-xl font-bold tracking-tight text-white drop-">Project Competencies</h1>
    ...
    <main class="flex-1 -mt-10 px-4 z-10 relative overflow-y-auto pb-28" id="mainContainer">
        ...
        <div id="step2-board" class="hidden">

            <div class="bg-white p-4 rounded-2xl  border border-slate-100 mb-4 flex justify-between items-center">
                <div>
                    <h2 id="projectStreamTitle" class="font-bold text-slate-800 text-lg">Stream</h2>
                    <p id="projectSubjectTitle" class="text-xs text-brand font-semibold uppercase">Subject</p>
                </div>
            </div>

            <div id="competencyTabsContainer"
                class="bg-slate-200/70 p-1 rounded-2xl flex gap-1 mb-5 border border-slate-200 -inner"></div>

            <div id="projectLearnersList" class="flex flex-col gap-3"></div>
    ...
    <div id="submitBar" class="fixed bottom-[70px] left-0 w-full px-5 pb-3 hidden z-30">
        <button onclick="submitProjectScores()" id="submitBtn"
            ...
            <span>Save Competency Scores</span>
        </button>
    </div>
    ...
    <nav
        ...
        <button class="flex flex-col items-center gap-1 text-brand"><i data-lucide="folder-kanban"
                class="w-6 h-6 fill-brand/10"></i><span class="text-[10px] font-bold">Projects</span></button>
