...
<body class="text-slate-800 antialiased h-screen flex flex-col relative">
    ...
    <header class="app-header text-white pt-10 pb-16 px-5 rounded-b-[2rem] flex-shrink-0 z-0 relative shadow-lg overflow-hidden">
        ...
        <div class="flex justify-between items-center relative z-10">
            ...
            <h1 class="text-xl font-bold tracking-tight text-white drop-shadow-sm">Project Competencies</h1>
    ...
    <main class="flex-1 -mt-10 px-4 z-10 relative overflow-y-auto pb-28" id="mainContainer">
        ...
        <div id="step2-board" class="hidden">
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 mb-4 flex justify-between items-center">
                <div>
            ...
            <div id="competencyTabsContainer" class="bg-slate-200/70 p-1 rounded-2xl flex gap-1 mb-5 border border-slate-200 shadow-inner"></div>
    ...
    <div id="submitBar" class="fixed bottom-[70px] left-0 w-full px-5 pb-3 hidden z-30">
        <button onclick="submitProjectScores()" id="submitBtn" class="w-full bg-brand hover:bg-brand-dark text-white font-bold py-4 rounded-2xl shadow-[0_10px_20px_-10px_rgba(10,88,202,0.5)] transition-all active:scale-95 flex items-center justify-center gap-2">
    ...
    <nav class="fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 flex justify-between px-6 pt-3 pb-safe z-40">
        ...
        <button class="flex flex-col items-center gap-1 text-brand"><i data-lucide="folder-kanban" class="w-6 h-6 fill-brand/10"></i><span class="text-[10px] font-bold">Projects</span></button>
