...
<body class="text-slate-800 antialiased h-screen flex flex-col relative">
    ...
    <header
        ...
        <div
            class="inline-flex items-center gap-1.5 bg-white/10 border border-white/15 px-3 py-1 rounded-full mb-5 backdrop-blur-sm relative z-10">
        ...
        <div class="flex justify-between items-end mb-1 relative z-10">
            <div>
                ...
                <h1 id="teacherName" class="text-2xl font-bold tracking-tight text-white drop-">Loading...</h1>
            </div>
            <div id="teacherInitials"
                class="w-11 h-11 rounded-full bg-gradient-to-br from-white/20 to-white/5 border border-white/20 flex items-center justify-center font-bold text-sm backdrop-blur-md -inner">
                --
            </div>
        </div>
    </header>
    ...
    <main class="flex-1 -mt-8 px-5 z-10 relative overflow-y-auto pb-28">
        ...
        <section
            class="bg-white p-4 rounded-2xl  border border-slate-100 flex items-center justify-between mb-6 backdrop-blur-sm bg-white/90">
        ...
        <div class="grid grid-cols-2 gap-3 mb-6">
            ...
            <button onclick="navigateTo('attendance.php')"
                class="bg-white p-4 rounded-2xl text-center border border-slate-100  active:scale-95 transition-transform flex flex-col items-center gap-2">
            ...
            <button onclick="navigateTo('aoi.php')"
                class="bg-white p-4 rounded-2xl text-center border border-slate-100  active:scale-95 transition-transform flex flex-col items-center gap-2">
            ...
            <button onclick="navigateTo('sa.php')"
                class="bg-white p-4 rounded-2xl text-center border border-slate-100  active:scale-95 transition-transform flex flex-col items-center gap-2">
            ...
            <button onclick="navigateTo('projects.php')"
                class="bg-white p-4 rounded-2xl text-center border border-slate-100  active:scale-95 transition-transform flex flex-col items-center gap-2">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <button onclick="navigateTo('reports.php')"
                class="bg-white p-4 rounded-2xl text-center border border-slate-100  active:scale-95 transition-transform flex flex-col items-center gap-2">
            ...
            <button onclick="navigateTo('students.php')"
                class="bg-white p-4 rounded-2xl text-center border border-slate-100  active:scale-95 transition-transform flex flex-col items-center gap-2">
    ...
    <nav
        class="fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 flex justify-between px-6 pt-3 pb-safe z-40 -[0_-4px_6px_-1px_rgba(0,0,0,0.02)]">
        ...
        <button onclick="navigateTo('attendance.php')"
            class="flex flex-col items-center gap-1 text-slate-400 hover:text-slate-600 transition-colors">
