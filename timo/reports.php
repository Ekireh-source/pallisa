...
<body class="text-slate-800 antialiased h-screen flex flex-col relative">
    ...
    <header class="app-header text-white pt-10 pb-16 px-5 rounded-b-[2rem] flex-shrink-0 z-0 relative  overflow-hidden">
        <div
        ...
        <div class="flex justify-between items-center relative z-10">
            ...
            <h1 class="text-xl font-bold tracking-tight text-white drop-">Class Analytics</h1>
    ...
    <main class="flex-1 -mt-10 px-4 z-10 relative overflow-y-auto pb-10" id="mainContainer">
        ...
        <div id="step1-streams">
            <h3 class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-3 ml-1">Select a Stream for
                Insights</h3>
        ...
        <div id="step2-analytics" class="hidden space-y-4">
            ...
            <div class="bg-white p-5 rounded-2xl  border border-slate-100">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div
                        class="relative w-8 h-8 flex items-center justify-center bg-slate-100 rounded-xl border border-slate-200 text-slate-500 hover:bg-slate-200 active:scale-95 transition-all cursor-pointer">
                ...
                <div
                    class="bg-slate-100 p-1 rounded-xl flex gap-1 mb-4 text-center border border-slate-200 -inner">
                    <button onclick="toggleAttendanceFilter('day')" id="btnAttDay"
                        class="flex-1 py-1.5 text-[11px] font-semibold rounded-lg text-slate-500 transition-all">Today</button>
                    <button onclick="toggleAttendanceFilter('week')" id="btnAttWeek"
                        class="flex-1 py-1.5 text-[11px] font-semibold rounded-lg text-slate-500 transition-all">This
                        Week</button>
                    <button onclick="toggleAttendanceFilter('term')" id="btnAttTerm"
                        class="flex-1 py-1.5 text-[11px] font-bold rounded-lg bg-white text-brand  transition-all">This
                        Term</button>
                </div>

                <div class="flex items-center gap-5 bg-slate-50 p-4 rounded-xl border border-slate-100">
                    <div id="attPieChart" class="pie-chart flex-shrink-0 "></div>
                    <div class="flex-1 space-y-1.5">
                        ...
                        <div class="space-y-1 text-xs text-slate-500 font-medium">
                            <div class="flex items-center justify-between"><span>Present:</span> <span
                                    id="lblPresentCount" class="font-bold text-slate-700">0</span></div>
                            <div class="flex items-center justify-between"><span>Absent:</span> <span
                                    id="lblAbsentCount" class="font-bold text-rose-500">0</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-5 rounded-2xl  border border-slate-100">
                ...
                <div id="aoiPaginationControls"
                    class="flex justify-between items-center mt-4 pt-3 border-t border-slate-100 hidden">
                    <button onclick="paginateAoi(-1)" id="btnAoiPrev"
                        class="flex items-center gap-1 text-xs font-bold text-brand disabled:text-slate-300">
                        <i data-lucide="chevron-left" class="w-4 h-4"></i> Prev
                    </button>
                    <span id="txtAoiPageIndicator"
                        class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Page 1 of 1</span>
                    <button onclick="paginateAoi(1)" id="btnAoiNext"
                        class="flex items-center gap-1 text-xs font-bold text-brand disabled:text-slate-300">
            ...
            <div class="bg-white p-5 rounded-2xl  border border-slate-100">
                ...
                <div id="saInsightBox"
                    class="bg-slate-50 border border-slate-100 rounded-xl p-3 text-xs leading-relaxed text-slate-600">
