...
<body class="text-slate-800 antialiased h-screen flex flex-col relative">
    ...
    <header class="app-header text-white pt-10 pb-16 px-5 rounded-b-[2rem] flex-shrink-0 z-0 relative shadow-lg overflow-hidden">
        ...
        <div class="flex justify-between items-center relative z-10">
            ...
            <h1 class="text-xl font-bold tracking-tight text-white drop-shadow-sm">My Students</h1>
    ...
    <main class="flex-1 -mt-10 px-4 z-10 relative overflow-y-auto pb-10" id="mainContainer">
        ...
        <div id="step1-streams">
            <h3 class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-3 ml-1">Select a Stream to view roster</h3>
        ...
        <div id="step2-directory" class="hidden space-y-4">
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex justify-between items-center sticky top-0 z-20 backdrop-blur-sm bg-white/90">
                <div>
                ...
                <div class="bg-cyan-50 text-cyan-700 px-3 py-1.5 rounded-xl font-bold text-xs flex items-center gap-1.5 border border-cyan-100/50">
                    <i data-lucide="users" class="w-3.5 h-3.5"></i>
                    <span id="lblRosterCount">0 Learners</span>
                </div>
            </div>

            <div class="relative flex items-center bg-white border border-slate-200 rounded-2xl px-4 py-3 shadow-sm focus-within:border-brand transition-colors">
