  ...
  const columns: ColumnDef<ICompetencyAreaListResponse>[] = [
    {
      ...
      cell: (area) => (
        <div className="font-bold flex items-center gap-3">
          ...
          <div>
            <p className="text-My-Black font-semibold">{area.name}</p>
          </div>
        </div>
      ),
    },
    {
      ...
      header: "Class",
      cell: (area) => (
        <span className="font-medium text-My-Black">{area.class_name || 'N/A'}</span>
      ),
    },
    {
      key: "term_name",
      header: "Term",
      cell: (area) => (
        <span className="font-medium text-My-Black">{area.term_name || 'N/A'}</span>
      ),
    },
    {
      key: "topic_name",
      ...
      cell: (area) => (
        <span className="font-medium text-My-Black">{area.topic_name || 'N/A'}</span>
      ),
    },
    {
      key: "actions",
            ...
            <PaginatedTable
              ...
              emptyState={
                <div className="flex flex-col items-center justify-center text-gray-500 py-12">
                  <LayoutGrid className="w-12 h-12 text-My-Black mb-4" />
