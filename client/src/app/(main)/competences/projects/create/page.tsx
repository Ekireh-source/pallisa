          ...
          <Card className="p-6 border-none  ring-1 ring-gray-100">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-bold text-My-Black flex items-center">
                ...
                <Input
                  ...
                  className="h-12 rounded-xl border-gray-200 bg-white  w-full text-base font-semibold"
                />
                {errors.name && (
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <StreamSearchableSelect
                      ...
                      triggerClassName="h-12 rounded-xl bg-white border-gray-200  w-full font-semibold text-base"
                    />
                  )}
                />
                {errors.stream_id && (
              ...
              <Button
                type="submit"
                className="w-full rounded-xl h-12  -primary/20 bg-primary hover:bg-primary/95 text-white font-bold transition-all text-base"
                disabled={submitting}
              >
