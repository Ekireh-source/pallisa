...
export default function DashboardPage() {
  ...
  const layoutStats = [
    {
      ...
      value: analytics ? String(analytics.total_students) : "...",
      change: "0%",
      isPositive: true,
      icon: "lucide:users",
    },
    {
      ...
      value: analytics ? String(analytics.total_teachers) : "...",
      change: "0%",
      isPositive: true,
    ...
    },
    {
      ...
      value: analytics ? String(analytics.monthly_revenue) : "...",
      change: "0%",
      isPositive: true,
    ...
    },
    {
      ...
      value: analytics ? String(analytics.monthly_expenses) : "...",
      change: "0%",
      isPositive: false,
  ...
  return (
    <MainLayout
      title={`Welcome back, ${user?.value?.first_name || 'Admin'}!`}
      description={`Here's what's happening at ${school?.name || 'your school'} today.`}
      stats={layoutStats}
      headerActions={
        <div className="flex items-center gap-3">
          <Button variant="outline" className="h-11 rounded-xl bg-white hover:bg-gray-50 transition-colors border-white/20 text-white hover:text-white/80 bg-white/10">
                ...
                <Table>
                  ...
                  <TableBody>
                    {recentTransactions && recentTransactions.length > 0 ? (
                            ...
                            <div className="flex items-center gap-3">
                              <Avatar className="h-8 w-8 ring-2 ring-white">
                                <AvatarFallback className="bg-primary/10 text-primary text-xs font-bold">
                                  {tx.student?.split(' ').map((n: any) => n[0]).join('') || 'ST'}
                                </AvatarFallback>
                              </Avatar>
                              {tx.student}
                            </div>
                      ...
                      <TableRow>
                        <TableCell colSpan={5} className="text-center py-8 text-gray-500 italic text-sm">
