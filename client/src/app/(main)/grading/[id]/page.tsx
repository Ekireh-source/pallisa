  ...
  return (
    <ProtectedComponent permissionCode={PERMISSION_CODES.VIEW_GRADING}>
      <MainLayout
        ...
        headerActions={
          <Button className=" border border-transparent rounded-xl h-11 bg-white text-primary hover:bg-gray-100 font-bold px-6" asChild>
                      ...
                      {system.boundaries?.length === 0 ? (
                        ...
                        system.boundaries?.map((boundary) => (
                          <TableRow key={boundary.id} className="hover:bg-gray-50">
                            ...
                            <TableCell className="text-My-Black">
                              {boundary.remarks || '--'}
                            </TableCell>
                          </TableRow>
                        ))
                ...
                <div className="space-y-6">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-My-Black">
                      {system.description || <span className="italic text-My-Black">No description provided.</span>}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 ">
                    ...
                    {system.is_active ? (
                      ...
                      <XCircle className="w-6 h-6 text-My-Black" />
                    )}
                  </div>
                </div>
              </Card>
