...
export default function TeacherDetailPage({ params }: PageProps) {
  ...
  const DetailItem = ({ icon: Icon, label, value, color = "text-gray-500" }: any) => (
    <div className="flex items-start gap-3 p-4 rounded-2xl hover:bg-gray-50 transition-colors">
      ...
      <div>
        <p className="text-xs font-semibold text-My-Black uppercase tracking-wider mb-1">{label}</p>
    ...
    <ProtectedComponent permissionCode={PERMISSION_CODES.VIEW_TEACHERS}>
      <MainLayout
        ...
        headerActions={
          <div className="flex items-center gap-3">
            <Button
              className="rounded-xl h-11 px-6 font-bold bg-white text-primary hover:bg-gray-100 hover:text-primary  transition-all gap-2"
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="rounded-2xl p-2 min-w-[200px] -xl border-none ring-1 ring-gray-100 bg-white">
                <DropdownMenuItem className="rounded-xl p-3 cursor-pointer" onClick={() => setActiveTab('assignments')}>
                  <Icon icon="hugeicons:task-list-done" className="w-4 h-4 mr-3 text-My-Black" />
                  <span>View Teaching Load</span>
                </DropdownMenuItem>
                <DropdownMenuItem className="rounded-xl p-3 cursor-pointer" onClick={() => setActiveTab('history')}>
                  <Icon icon="hugeicons:clock-01" className="w-4 h-4 mr-3 text-My-Black" />
      ...
      >
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 mt-6">
          ...
          <Card className="p-8 border-none -xl -gray-200/50 rounded-[32px] ring-1 ring-gray-100 overflow-hidden relative group bg-white">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left w-full lg:w-auto">
                <div className="w-28 h-28 rounded-[2rem] bg-indigo-100 p-1 ring-4 ring-indigo-50 -xl flex items-center justify-center overflow-hidden shrink-0">
                ...
                <div className="space-y-2">
                  <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                    <h2 className="text-3xl font-extrabold text-My-Black tracking-tight">
                      {teacher.full_name || `${teacher.user_profile_data?.first_name} ${teacher.user_profile_data?.last_name}`}
                    </h2>
                    <Badge className={`rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-widest border-none ${teacher.is_active
                  ...
                  <p className="text-gray-500 font-medium text-sm flex flex-wrap items-center justify-center md:justify-start gap-x-2 gap-y-1">
                    ...
                    <span className="text-My-Black font-semibold bg-gray-100 px-2.5 py-0.5 rounded-full text-xs">{teacher.employment_type?.replace('_', ' ') || ''}</span>
                    <span className="w-1.5 h-1.5 rounded-full bg-gray-300 hidden md:inline" />
                    <span className="text-My-Black font-semibold">{teacher.school_name || ''}</span>
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full lg:w-auto shrink-0">
                <div className="p-4 rounded-2xl bg-gray-50/80 border border-gray-100 text-center min-w-[110px]">
                  ...
                  <p className="text-base font-extrabold text-My-Black">{teacher.user_profile_data?.gender === 'M' ? 'Male' : teacher.user_profile_data?.gender === 'F' ? 'Female' : 'Other'}</p>
                </div>
                <div className="p-4 rounded-2xl bg-gray-50/80 border border-gray-100 text-center min-w-[110px]">
                  <p className="text-[10px] font-bold text-My-Black uppercase tracking-widest mb-1">Experience</p>
                  <p className="text-base font-extrabold text-My-Black">{teacher.years_of_experience || '0'} Yrs</p>
                </div>
                <div className="p-4 rounded-2xl bg-gray-50/80 border border-gray-100 text-center min-w-[110px]">
                  <p className="text-[10px] font-bold text-My-Black uppercase tracking-widest mb-1">Specialization</p>
                  <p className="text-base font-extrabold text-My-Black truncate max-w-[100px]">{teacher.specialization || 'N/A'}</p>
                </div>
                <div className="p-4 rounded-2xl bg-gray-50/80 border border-gray-100 text-center min-w-[110px]">
                  <p className="text-[10px] font-bold text-My-Black uppercase tracking-widest mb-1">Hire Date</p>
                  <p className="text-base font-extrabold text-My-Black truncate max-w-[100px]">
          ...
          <div className="w-full space-y-6">
            <Card className="p-2 border-none -xl -gray-200/50 rounded-[32px] ring-1 ring-gray-100 bg-white">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="bg-transparent border-b border-gray-100 w-full justify-start h-auto p-4 gap-2 overflow-x-auto flex-wrap">
                  <TabsTrigger
                    value="professional"
                    className="rounded-xl px-6 py-3 font-bold text-sm data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]: transition-all flex items-center gap-2"
                  >
                ...
                <div className="p-8">
                  ...
                  <TabsContent value="professional" className="m-0 space-y-8 animate-in fade-in duration-500 focus-visible:outline-none">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        <h4 className="text-xs font-bold text-My-Black uppercase tracking-widest mb-2">Employment Information</h4>
                      ...
                      <div className="space-y-4">
                        <h4 className="text-xs font-bold text-My-Black uppercase tracking-widest mb-2">Contact Details & Biography</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="pt-8 border-t border-gray-100">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="p-5 rounded-2xl bg-gray-50 border border-gray-100">
                          <p className="text-sm font-bold text-My-Black mb-1">{teacher.user_profile_data?.emergency_phone || 'N/A'}</p>
                  ...
                  <TabsContent value="assignments" className="m-0 space-y-6 animate-in fade-in duration-500 focus-visible:outline-none">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl bg-indigo-50/40 border border-indigo-100">
                      <div>
                        <h4 className="text-lg font-bold text-My-Black">Teaching Assignments & Subject Loads</h4>
                      ...
                      <Button
                        ...
                        className="rounded-xl px-6 h-11 bg-primary text-white hover:bg-primary/90 font-bold  -primary/20 flex items-center gap-2 self-start sm:self-auto shrink-0"
                      >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                      {teacher.subject_assignments?.length > 0 ? (
                        teacher.subject_assignments.map((assign: any, idx: number) => (
                          <div key={idx} className="p-5 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-between group hover:bg-white transition-all  hover:">
                            <div className="flex items-center gap-4">
                              <div className="w-12 h-12 rounded-xl bg-white  flex items-center justify-center text-indigo-600">
                                <BookOpen className="w-5 h-5" />
                              </div>
                              <div>
                                <p className="text-sm font-bold text-My-Black">{assign.subject_name}</p>
                        ...
                        <div className="col-span-2 p-16 text-center rounded-3xl bg-gray-50 border-2 border-dashed border-gray-200">
                          <BookOpen className="w-12 h-12 text-My-Black mx-auto mb-4 animate-pulse" />
                      ...
                      <div className="space-y-8">
                        <div className="relative pl-14">
                          ...
                          <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100">
                            ...
                            <h5 className="font-bold text-My-Black mb-1">{teacher.employment_type?.replace('_', ' ') || ''}</h5>
                        ...
                        <div className="relative pl-14">
                          ...
                          <div className="p-6 rounded-2xl bg-white ring-1 ring-gray-100">
                            <p className="text-xs font-bold text-My-Black uppercase tracking-widest mb-1">Record Created</p>
