...
import { selectTeacher } from '@/store/auth/selectors';
...
export default function CreateActivityPage() {
  ...
  const loggedInTeacher = useSelector(selectTeacher);
  const isTeacher = !!loggedInTeacher;
  ...
  useEffect(() => {
    if (isTeacher && loggedInTeacher?.id && !selectedTeacher) {
      setValue('teacher', loggedInTeacher.id, { shouldValidate: true });
    }
  }, [isTeacher, loggedInTeacher, setValue, selectedTeacher]);
