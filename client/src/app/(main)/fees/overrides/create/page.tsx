...
import { ArrowLeft, Save, Loader2, Search, User, AlertCircle, Info, DollarSign } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white shadow-xl">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">Create Student Fee Override</h1>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 text-blue-100">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm">New Override Creation</span>
            </div>
          </div>
          <Link
            href="/fees/overrides"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <select
                id="category"
                className={`block w-full px-4 py-3 border-2 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 ${fieldErrors.category ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'}`}
              ...
              {fieldErrors.category && (
                <div className="mt-2 flex items-center space-x-2 text-red-600">
                  <AlertCircle className="w-4 h-4" />
                  <p className="text-sm">{fieldErrors.category}</p>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="number"
                  id="custom_amount"
                  className={`block w-full pl-12 px-4 py-3 border-2 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 ${fieldErrors.custom_amount ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50 focus:bg-white'}`}
              ...
              {fieldErrors.custom_amount && (
                <div className="mt-2 flex items-center space-x-2 text-red-600">
                  <AlertCircle className="w-4 h-4" />
                  <p className="text-sm">{fieldErrors.custom_amount}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              id="reason"
              rows={4}
              className="block w-full px-4 py-3 border-2 border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 focus:bg-white transition-all duration-300"
          ...
          <div className="flex items-center p-4 bg-blue-50 rounded-xl border border-blue-200">
            ...
            <label htmlFor="is_active" className="ml-3 block text-sm text-gray-900">
              ...
              <span className="text-gray-600 ml-1">(override can be applied to fees)</span>
            </label>
          </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg border-0 overflow-hidden">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-blue-200">
          <h3 className="text-lg font-semibold text-blue-800 flex items-center">
            ...
            Tips for Creating Fee Overrides
          </h3>
        </div>
        <div className="p-6">
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <p className="text-gray-700">Select the specific fee category to override</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-blue-600 text-xs font-semibold">3</span>
              </div>
              <p className="text-gray-700">Set the custom amount for this specific student</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-blue-600 text-xs font-semibold">4</span>
              </div>
              <p className="text-gray-700">Provide a clear reason for the override for record keeping</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-blue-600 text-xs font-semibold">5</span>
              </div>
              <p className="text-gray-700">Only active overrides will be applied to student fees</p>
            </div>
          </div>
        </div>
      </div>
