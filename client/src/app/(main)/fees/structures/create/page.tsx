      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <select
                  id="class_obj"
                  className={`block w-full border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${fieldErrors.class_obj ? 'border-red-300' : 'border-gray-300'}`}
                ...
                {fieldErrors.class_obj && (
                  <p className="mt-1 text-sm text-red-600">{fieldErrors.class_obj}</p>
                )}
              </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Tips for creating fee structures</h3>
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>Assign each structure to a specific class, academic year, and term</li>
                  <li>Use clear, descriptive names for categories and classes</li>
                  <li>Amount should reflect the total fee for the structure</li>
                  <li>Only active structures will be available for new fee assignments</li>
                </ul>
              </div>
            </div>
          </div>
