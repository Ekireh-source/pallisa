      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <input
                type="text"
                id="scholarship_name"
                className={`block w-full border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${fieldErrors.scholarship_name ? 'border-red-300' : 'border-gray-300'}`}
              ...
              {fieldErrors.scholarship_name && (
                <p className="mt-1 text-sm text-red-600">{fieldErrors.scholarship_name}</p>
              )}
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    id="amount"
                    className={`block w-full pl-7 border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${fieldErrors.amount ? 'border-red-300' : 'border-gray-300'}`}
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="is_active" className="ml-2 block text-sm text-gray-900">
                Active (scholarship can be used for new fees)
              </label>
            </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Tips for creating scholarships</h3>
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>Search for students by name or student ID</li>
                  <li>Assign each scholarship to a specific student, academic year, and term</li>
                  <li>Use clear, descriptive names for scholarships and awards</li>
                  <li>Amount should reflect the total value of the scholarship</li>
                  <li>Only active scholarships will be available for new fee assignments</li>
                </ul>
              </div>
            </div>
          </div>
