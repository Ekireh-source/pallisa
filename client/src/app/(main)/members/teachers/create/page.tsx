...
import { createTeacher, clearFieldErrors, fetchTeachers } from '@/store/slices/memberTeacherSlice';
...
export default function CreateTeacherPage() {
  ...
  const { loading, error, fieldErrors } = useAppSelector((state) => state.memberTeachers);
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Create a comprehensive teacher record with all required information</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card className="bg-white shadow-sm border border-gray-100">
          <CardHeader>
            ...
            <CardDescription>
              Emergency contact details for staff safety
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="bg-white shadow-sm border border-gray-100">
          <CardHeader>
            ...
            <CardDescription>
              Qualifications, specialization, and experience details
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={handleInputChange}
                placeholder="Describe previous teaching experience and achievements"
                rows={4}
              />
        ...
        <Card className="bg-white shadow-sm border border-gray-100">
          <CardHeader>
            ...
            <CardDescription>
              Employment type and hiring details
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
