    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white shadow-xl">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">Expense Categories</h1>
            <p className="text-blue-100 text-lg">
              Organize and manage expense categories for better financial tracking
            </p>
          </div>
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 text-blue-100">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm">Total Expenses: {categories.reduce((sum, cat) => sum + cat.expense_count, 0)}</span>
            </div>
          </div>
          <Link
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-purple-600">Avg Expenses/Category</p>
