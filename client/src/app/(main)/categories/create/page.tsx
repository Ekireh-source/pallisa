            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Consider creating broad categories that can encompass multiple expense types</li>
                  <li>Examples: Office Supplies, Travel & Transportation, Utilities, Professional Services</li>
