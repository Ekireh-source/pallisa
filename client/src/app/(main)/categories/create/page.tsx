...
import { createExpenseCategory, clearError } from '@/store/slices/expenseCategorySlice';
...
export default function CreateCategoryPage() {
  ...
  const { loading = false, error = null } = expenseCategoryState || {};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await dispatch(createExpenseCategory(formData)).unwrap();
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white shadow-xl">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold mb-2">Create Expense Category</h1>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 text-blue-100">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm">Organize expenses efficiently</span>
            </div>
          </div>
          <Link
            href="/categories"
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <ul className="space-y-2 text-sm text-blue-700">
                ...
                <li className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Consider creating broad categories that can encompass multiple expense types</span>
                </li>
                <li className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>Examples: Office Supplies, Travel & Transportation, Utilities, Professional Services</span>
                </li>
                <li className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span>You can always create subcategories later as your needs grow</span>
                </li>
              </ul>
            </div>
          </div>
