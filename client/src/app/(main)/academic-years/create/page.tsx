      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
            ...
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500">Create Academic Year</span>
                </div>
              </li>
            </ol>
          </nav>
          <div className="mt-4">
            ...
            <p className="mt-2 text-gray-600">
              Add a new academic year to organize your terms and expenses
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Tips for creating academic years</h3>
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>Use a consistent naming format like &quot;2024/2025&quot; or &quot;AY 2024-25&quot;</li>
                  <li>Academic years typically run from August/September to May/June</li>
                  <li>Only one academic year should be marked as &quot;current&quot; at a time</li>
                  <li>You can create terms for this academic year after saving</li>
                </ul>
              </div>
            </div>
          </div>
