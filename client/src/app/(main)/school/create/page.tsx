          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                      ...
                      {logoPreview ? (
                        <>
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-semibold text-My-Black">{logoFile?.name}</p>
                            <p className="text-xs text-My-Black">{((logoFile?.size || 0) / 1024).toFixed(1)} KB · Click to change</p>
                          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-2 space-y-2">
                <Button type="submit" className="w-full h-12 rounded-xl  -primary/20 font-bold" disabled={loading || fetchingCampuses}>
