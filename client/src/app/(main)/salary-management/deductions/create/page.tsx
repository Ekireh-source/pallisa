...
import { ArrowLeft, Save, Loader2, TrendingDown, Shield, Heart, Clock, AlertTriangle, Settings, Activity, FileText } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-6 sm:p-8 text-white shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold mb-2">Create Salary Deduction</h1>
            <p className="text-red-100 text-base sm:text-lg">
              Add a new salary deduction for staff members
            </p>
          </div>
        </div>
