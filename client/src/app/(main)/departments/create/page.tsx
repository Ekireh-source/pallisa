      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              <li>
                <div>
                  <Link href="/departments" className="text-gray-400 hover:text-gray-500">
                    Departments
                  </Link>
                </div>
              </li>
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500">Create Department</span>
                </div>
              </li>
            </ol>
          </nav>
          <div className="mt-4">
            ...
            <p className="mt-2 text-gray-600">
              Add a new department to organize expenses by organizational unit
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Tips for creating departments</h3>
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>Use clear, recognizable department names that match your organization structure</li>
                  <li>Examples: Marketing, IT & Technology, Finance & Accounting, Human Resources</li>
                  <li>Consider creating departments that align with your budget structure</li>
                  <li>Departments help track expenses by organizational unit for better reporting</li>
                </ul>
              </div>
            </div>
          </div>
