            ...
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500">Edit {currentDepartment?.name}</span>
                </div>
              </li>
            </ol>
          </nav>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <span className="ml-2 font-medium">{currentDepartment.expense_count}</span>
                  </div>
                  <div>
