...
export default function SaAssessmentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const getPercentageBadge = (pct: number | null) => {
    if (pct === null) return <span className="text-My-Black font-semibold text-xs">Ungraded</span>;
      ...
      <ProtectedComponent permissionCode={PERMISSION_CODES.VIEW_GRADING}>
        ...
        >
          <div className="space-y-8 animate-in fade-in duration-500 mt-[24px]">
            ...
            <Card className="p-6 border-none  ring-1 ring-gray-100 bg-gray-50/40">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
                <div className="relative md:col-span-2">
                  ...
                  <Input
                    ...
                    className="pl-11 h-12 rounded-xl border-gray-200 bg-white "
                    value={searchTerm}
                ...
                <div className="flex items-center gap-2 md:col-span-2">
                  <Button
                    variant="outline"
                    className="flex-1 h-12 rounded-xl bg-white hover:bg-gray-50 border-gray-200  font-semibold"
                  ...
                  <div className="flex-1 relative">
                    ...
                    <Button
                      variant="outline"
                      className="w-full h-12 rounded-xl bg-white hover:bg-gray-50 border-gray-200  font-semibold"
                      asChild
                    >
              ...
              <div className="overflow-x-auto">
                <Table className="min-w-max border-collapse">
                  <TableHeader className="bg-gray-50/80 border-b border-gray-100">
                    <TableRow>
                      <TableHead rowSpan={2} className="font-bold text-My-Black w-60 px-6 py-4 border-r border-gray-100">Student Info</TableHead>
                      <TableHead colSpan={2} className="font-bold text-My-Black text-center px-4 py-2 border-r border-gray-100 bg-indigo-50/20">Milestone 1</TableHead>
                      <TableHead colSpan={2} className="font-bold text-My-Black text-center px-4 py-2 border-r border-gray-100">Milestone 2</TableHead>
                      <TableHead colSpan={2} className="font-bold text-My-Black text-center px-4 py-2 border-r border-gray-100 bg-indigo-50/20">Milestone 3</TableHead>
                      <TableHead colSpan={2} className="font-bold text-My-Black text-center px-4 py-2 border-r border-gray-100">Milestone 4</TableHead>
                      <TableHead colSpan={2} className="font-bold text-My-Black text-center px-4 py-2 border-r border-gray-100 bg-indigo-50/20">Milestone 5</TableHead>
                      <TableHead rowSpan={2} className="font-bold text-My-Black text-center w-24 px-4 py-4 border-l border-gray-100">Sum</TableHead>
                      <TableHead rowSpan={2} className="font-bold text-My-Black text-center w-32 px-6 py-4">Final %</TableHead>
                    </TableRow>
                        ...
                        return (
                          <TableRow key={student.student_id} className="hover:bg-gray-50/20 transition-colors border-b border-gray-100">
                            <TableCell className="px-6 py-3 border-r border-gray-100">
                              <div className="flex flex-col">
                                <span className="font-bold text-My-Black text-sm">{student.student_name}</span>
                                <span className="text-xs text-My-Black font-medium">{student.admission_number}</span>
                              </div>
                            </TableCell>
                            ...
                            <TableCell className="text-center font-bold text-My-Black border-l border-r border-gray-100 px-4 py-3 bg-gray-50/10">
