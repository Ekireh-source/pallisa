...
export default function SubjectsListPage() {
  ...
  const columns: ColumnDef<ISubjectListResponse>[] = [
      ...
      cell: (subject) => (
        <div className="font-bold flex items-center gap-2 sm:gap-3">
          ...
          <div className="min-w-0">
            <p className="text-My-Black font-bold text-sm sm:text-base truncate">{subject.name}</p>
    ...
    },
    {
      ...
      cell: (subject) => (
        <span className="font-semibold text-My-Black">{subject.department || 'General'}</span>
      ),
    },
    {
      key: "active",
