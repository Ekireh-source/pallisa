    ...
    <div className="max-w-4xl mx-auto px-4 md:px-0 space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Edit Term</h1>
            <p className="text-gray-500 text-sm sm:text-base mt-1">Update academic term details.</p>
          </div>
        </div>
        <Button 
          variant="outline" 
