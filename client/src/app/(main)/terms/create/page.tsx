      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
            ...
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-sm font-medium text-gray-500">Create Term</span>
                </div>
              </li>
            </ol>
          </nav>
          <div className="mt-4">
            ...
            <p className="mt-2 text-gray-600">
              Add a new term to organize expenses by academic periods
            </p>
          </div>
        </div>
        ...
        {academic_years.length === 0 && (
          <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-md p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">Academic Year Required</h3>
                <p className="mt-1 text-sm text-yellow-700">
                  You need to create at least one academic year before you can create terms.{' '}
                  <Link href="/academic-years/create" className="font-medium underline">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 p-6">
            ...
            <div>
              ...
              <select
                ...
                disabled={academic_years.length === 0}
              >
            ...
            <div className="flex justify-between pt-6 border-t">
              ...
              <button
                type="submit"
                disabled={loading || academic_years.length === 0}
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-blue-800">Tips for creating terms</h3>
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>Terms should belong to an academic year and fit within its date range</li>
                  <li>Common term names: Fall, Spring, Summer, or Term 1, Term 2, Term 3</li>
                  <li>Make sure term dates don&apos;t overlap with other terms in the same academic year</li>
                  <li>Terms help organize expenses by academic periods for better reporting</li>
                </ul>
              </div>
            </div>
          </div>
