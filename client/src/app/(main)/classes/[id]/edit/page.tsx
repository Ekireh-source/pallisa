...
import { FetchClassById, UpdateClass, DeleteClass } from '@/features/members/members.service';
      ...
      <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-My-Black">Edit Class</h1>
              <p className="text-gray-500 mt-1">Update grade level details.</p>
            </div>
          </div>
          <Button
            variant="outline"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-2">
                <Button
                  type="submit"
                  className="w-full h-12 rounded-xl  -blue-200 font-bold bg-primary hover:bg-primary/90"
                  disabled={loading}
                >
                  {loading ? (
