...
export default function ModernPallisaLanding() {
  ...
  return (
    <div className="min-h-screen bg-white text-My-Black overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="hidden md:grid grid-cols-3 items-center">
            ...
            <div className="flex justify-center items-center space-x-8">
              <Link href="#features" className="text-My-Black hover:text-blue-400 transition-colors">Features</Link>
              <Link href="#about" className="text-My-Black hover:text-blue-400 transition-colors">About</Link>
              <Link href="#contact" className="text-My-Black hover:text-blue-400 transition-colors">Contact</Link>
            </div>
            {/* Right: Login and Get Started Button */}
            <div className="flex justify-end items-center space-x-4">
              <Link href="/login" className="text-My-Black hover:text-blue-400 transition-colors">Login</Link>
              <Link href="/register" className="px-6 py-3 bg-primary text-primary-foreground rounded-full hover:bg-primary/90 transition-all duration-300 transform hover:scale-105  hover:-xl">
                Get Started
              </Link>
            </div>
          </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-xl border-b border-gray-200 p-6 space-y-4">
              <Link href="#features" className="block text-My-Black hover:text-blue-400 transition-colors">Features</Link>
              <Link href="#about" className="block text-My-Black hover:text-blue-400 transition-colors">About</Link>
              <Link href="#contact" className="block text-My-Black hover:text-blue-400 transition-colors">Contact</Link>
              <Link href="/login" className="block w-full text-left text-My-Black hover:text-blue-400 transition-colors">Login</Link>
      ...
      <section className="relative pt-32 pb-20 px-6 bg-white">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
            ...
            <br />
            <span className="text-My-Black">Education at</span>
            <br />
            <span className="text-blue-400">Pallisa High School</span>
          </h1>
          <p className="text-xl text-My-Black mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Link href="/dashboard" className="group px-8 py-4 bg-primary text-primary-foreground rounded-full font-semibold hover:bg-primary/90 transition-all duration-300 transform hover:scale-105  hover:-2xl flex items-center">
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="relative bg-gray-50 rounded-3xl p-8 border border-gray-200 -2xl">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-My-Black text-sm">Pallisa School Dashboard</div>
              </div>
              <div className="bg-white rounded-2xl h-80 flex items-center justify-center border border-gray-100">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-My-Black mb-2">Smart Dashboard</h3>
                  <p className="text-My-Black">AI-Powered School Management</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                ...
                <div className="text-3xl font-bold text-My-Black mb-1">{stat.number}</div>
                <div className="text-My-Black">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="features" className="py-20 px-6 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-My-Black mb-6">
              Powerful Features for
              <span className="text-blue-400 block">Modern Education</span>
            </h2>
            <p className="text-xl text-My-Black max-w-3xl mx-auto">
            ...
            {features.map((feature, index) => (
              <div key={index} className="group relative">
                <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 hover:border-blue-100 transition-all duration-300 transform hover:scale-105 h-full">
                  ...
                  <h3 className="text-xl font-bold text-My-Black mb-4">{feature.title}</h3>
                  <p className="text-My-Black leading-relaxed">{feature.description}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="relative mb-8">
                  <div className="w-24 h-24 bg-blue-50 rounded-3xl flex items-center justify-center mx-auto  group-hover:scale-110 transition-transform duration-300 border border-blue-100">
                    <span className="text-2xl font-bold text-blue-400">{item.step}</span>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-My-Black mb-4">{item.title}</h3>
                <p className="text-My-Black leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              <div className="bg-gray-50 rounded-3xl p-8 border border-gray-200">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                    ...
                    <div className="text-2xl font-bold text-My-Black">95%</div>
                    <div className="text-My-Black">Efficiency Boost</div>
                  </div>
                  <div className="bg-emerald-50 rounded-2xl p-6 border border-emerald-100">
                    <Shield className="w-8 h-8 text-emerald-400 mb-4" />
                    <div className="text-2xl font-bold text-My-Black">100%</div>
                    <div className="text-My-Black">Secure</div>
                  </div>
                  <div className="bg-pink-50 rounded-2xl p-6 border border-pink-100">
                    <Users className="w-8 h-8 text-pink-400 mb-4" />
                    <div className="text-2xl font-bold text-My-Black">2K+</div>
                    <div className="text-My-Black">Students</div>
                  </div>
                  <div className="bg-orange-50 rounded-2xl p-6 border border-orange-100">
                    <Zap className="w-8 h-8 text-orange-400 mb-4" />
                    <div className="text-2xl font-bold text-My-Black">24/7</div>
                    <div className="text-My-Black">Support</div>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-My-Black mb-8">
                Built for
                <span className="text-blue-400 block">Excellence & Growth</span>
              </h2>
              <p className="text-xl text-My-Black mb-8 leading-relaxed">
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-3">
                    ...
                    <span className="text-My-Black">{item}</span>
                  </div>
                ))}
              </div>
              <Link href="/auth/register" className="px-8 py-4 bg-primary text-primary-foreground rounded-full font-semibold hover:bg-primary/90 transition-all duration-300 transform hover:scale-105  hover:-xl flex items-center">
                Start Your Journey
        ...
        <div className="container mx-auto">
          <div className="relative">
            <div className="relative bg-gray-50 rounded-3xl p-12 border border-gray-200 text-center">
              ...
              <p className="text-xl text-My-Black mb-10 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/dashboard" className="px-10 py-4 bg-primary text-primary-foreground rounded-full font-bold text-lg hover:bg-primary/90 transition-all duration-300 transform hover:scale-105  hover:-2xl">
                  Access School Portal
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8 mb-6 md:mb-0">
              <Link href="/privacy" className="text-My-Black hover:text-blue-400 transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="text-My-Black hover:text-blue-400 transition-colors">Terms of Service</Link>
              <Link href="/contact" className="text-My-Black hover:text-blue-400 transition-colors">Contact</Link>
            </div>
